module MezuroInformations
  KALIBRO_PROCESSOR = {version: '1.1.3', release: '1', name: 'kalibro-processor',
  ...
  KALIBRO_CONFIGURATIONS = {version: '1.2.3', release: '1', name: 'kalibro-configurations',
                            ...
                            vcs_url: 'https://github.com/mezuro/kalibro_configurations.git',
    	                      ...
    	                      public_download_numbers: true }
  PREZENTO = {version: '0.9.2', release: '1', name: 'prezento',
